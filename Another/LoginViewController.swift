...
final class LoginViewController: UIViewController, UITextFieldDelegate {
    ...
    @objc private func login() {
        ...
        Auth.auth().signIn(withEmail: self.emailField.text!, password: self.passwordField.text!) { (authResult, error) in
            if let error = error as NSError? {
            switch AuthErrorCode(rawValue: error.code) {
            case .operationNotAllowed:
              print("Opertion not allowed")
            case .userDisabled:
              print("Disabled")
            case .wrongPassword:
            ...
            default:
              ...
              let alertcontroller = UIAlertController(title: "Congrats!", message: "Signed in", preferredStyle: .alert)
